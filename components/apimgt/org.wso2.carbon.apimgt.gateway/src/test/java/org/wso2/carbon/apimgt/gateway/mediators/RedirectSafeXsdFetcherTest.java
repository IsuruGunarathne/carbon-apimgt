...
public class RedirectSafeXsdFetcherTest {
    ...
    // ---- fetcher: the redirect bypass regression -------------------------------------------------
    ...
    public void testRedirectToBlockedHostIsRefusedAndNeverContacted() {
        ...
        try {
            ...
            // expected — the 302 Location is re-validated and rejected
        } catch (IOException e) {
            fail("expected a block, got IOException: " + e);
        }
    ...
    // ---- resolver level: same guarantees through AccessControlledXmlResolver ---------------------
