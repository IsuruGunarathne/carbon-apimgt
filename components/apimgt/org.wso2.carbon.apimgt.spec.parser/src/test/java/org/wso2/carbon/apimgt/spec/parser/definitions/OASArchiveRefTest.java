...
public class OASArchiveRefTest {
    ...
    public void remoteRefInBundledLocalFileIsBlocked() throws Exception {
        // master is clean and only refers to a LOCAL sibling; the sibling carries a remote $ref to a blocked host.
        // The archive-wide sweep must scan the bundled local file too and reject the remote ref with zero hits.
        AtomicInteger hits = new AtomicInteger();
        com.sun.net.httpserver.HttpServer server =
                com.sun.net.httpserver.HttpServer.create(new java.net.InetSocketAddress("127.0.0.1", 0), 0);
