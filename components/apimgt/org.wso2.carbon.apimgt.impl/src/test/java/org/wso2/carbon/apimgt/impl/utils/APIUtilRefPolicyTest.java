...
public class APIUtilRefPolicyTest {
    ...
    @Test public void testPlatformPolicyActiveSetsValidator() throws Exception {
        ...
        // The crawl fetch hook MUST also be wired, otherwise the crawl validates only direct refs and never fetches
        // or recurses into nested/transitive refs (the whole point of the recursive crawl).
